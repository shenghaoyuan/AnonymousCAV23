...
static struct jit_state st = {
    ...
    .thumb_len		= 0U,
    .thumb		= thumb_list,
    .ibpf       	= (unsigned long long *) bpf_fletcher32_compcert_bpf_bin,
    .jitted_len	= 0U,
...
int main(void){  
  ...
  bpf_regs_map[1] = (unsigned long long) (uintptr_t) (const uint16_t *) wrap_around_data;
  bpf_regs_map[2] = (unsigned long long) sizeof(wrap_around_data)/2;
